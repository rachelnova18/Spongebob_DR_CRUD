...
namespace CRUDMahasiswaADO
{
    public partial class Dashboard : Form
    {
            ...
            try
            {
                ...
                if (tipe == SeriesChartType.Column)
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        // PERBAIKAN DI SINI: Langsung Convert tanpa casting (long)
                ...
                else
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        // PERBAIKAN DI SINI JUGA: Langsung Convert tanpa casting (long)
                        int jumlah = Convert.ToInt32(row["JmlhMhs"]);
        ...
        {
            // Ganti DataMahasiswa menjadi Form1
            Form1 frm1 = new Form1();
            frm1.Show();
            this.Hide();
        }

        private void cmbTahunMasuk_SelectedIndexChanged(object sender, EventArgs e)
        {
